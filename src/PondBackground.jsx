...
export const PondBackground = ({ width = '100%', height = '100%' }) => {
  return (
    <div className="pond-background" style={{
      ...
      backgroundPosition: 'center bottom', // Adjust focus point if needed
      zIndex: 0,
      ...
      <style>
        {`
          .pond-background::after {
            ...
            background: radial-gradient(ellipse at center, rgba(0,150,255,0.1) 0%, rgba(0,100,200,0.2) 40%, rgba(0,50,150,0.3) 100%);
            opacity: 0.5;
